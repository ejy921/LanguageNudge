...
- Quiz: you can choose to have a quiz style card instead of a flashcard, or do both
...
[WELCOME]
    ├── upload file → [VOCAB_PARSED]
    ├── choose preset → [VOCAB_LOADED]

[VOCAB_PARSED or VOCAB_LOADED]
    ├── choose flashcards → [FLASHCARDS]
    ├── choose quiz → [QUIZ]
    ├── open vocab list → [LIST]
